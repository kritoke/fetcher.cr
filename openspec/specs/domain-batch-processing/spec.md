...
This specification defines the requirements for domain-based feed grouping and batch processing to reduce DNS lookups, TLS handshakes, and implement domain-specific rate limiting.
